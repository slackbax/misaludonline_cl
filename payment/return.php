            ...
            <div class="col-md-8 offset-md-2">
              <div class="card card-primary">
                ...
                <div class="card-body">
                  ...
                  <p class="mt-5">
                    <a href="https://www.misaludonline.cl">MiSaludOnline.cl</a> agradece tu preferencia!<br>Cualquier duda o consulta, dirígete al correo
                    <a href="mailto:contacto@alercesoftware.cl">contacto@alercesoftware.cl</a></p>
                  <p class="mt-5 text-gray font-italic">
                    <span class="fw-bolder">MiSaludOnline.cl</span> &copy; <?php echo date('Y') ?>
                    <a href="https://www.alercesoftware.cl/" target="_blank" class="text-primary fw-bolder">AlerceSoftware</a>
                  </p>
                </div>
              </div>
            </div>
